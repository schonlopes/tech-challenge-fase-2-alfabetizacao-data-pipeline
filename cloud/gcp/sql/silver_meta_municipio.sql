CREATE OR REPLACE TABLE `__PROJECT_ID__.alfabetizacao_silver.meta_alfabetizacao_municipio`
...
FROM `__PROJECT_ID__.alfabetizacao_bronze.meta_alfabetizacao_municipio`
QUALIFY ROW_NUMBER() OVER (
  PARTITION BY ano, id_municipio, rede ORDER BY _ingested_at DESC
) = 1;
