CREATE OR REPLACE TABLE `__PROJECT_ID__.alfabetizacao_silver.meta_alfabetizacao_uf`
...
FROM `__PROJECT_ID__.alfabetizacao_bronze.meta_alfabetizacao_uf`
QUALIFY ROW_NUMBER() OVER (
  PARTITION BY ano, sigla_uf, rede ORDER BY _ingested_at DESC
) = 1;
